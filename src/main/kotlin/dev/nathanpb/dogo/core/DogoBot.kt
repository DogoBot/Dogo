package dev.nathanpb.dogo.core

import com.google.common.reflect.TypeToken
import dev.nathanpb.dogo.core.command.CommandFactory
import dev.nathanpb.dogo.core.command.CommandManager
...
class DogoBot {
    companion object {
         ...
         */
        val data : DogoData = {
            val config = dev.nathanpb.dogo.core.DogoBot.Companion.dataLoader.load(
                    ConfigurationOptions.defaults()
                    .setShouldCopyDefaults(true)
            )
            val it = config.getValue(TypeToken.of(DogoData::class.java), DogoData())
            dev.nathanpb.dogo.core.DogoBot.Companion.dataLoader.save(config)
            it
        }()
         ...
         * The command factory.
         */
        val cmdFactory = CommandFactory(dev.nathanpb.dogo.core.DogoBot.Companion.cmdManager)
