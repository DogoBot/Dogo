package dev.nathanpb.dogo.discord.badwords
...
import dev.nathanpb.dogo.discord.permgroups
    ...
    fun check(msg: Message) {
        ...
        if (msg.author.id != DiscordManager.jda!!.selfUser.id && !msg.author.permgroups.can("badword.admin.bypass")) {
            ...
            if (container.isNotEmpty()) {
                ...
                dev.nathanpb.dogo.core.DogoBot.eventBus.submit(BadwordMessageCensoredEvent(msg.guild, msg, container))
