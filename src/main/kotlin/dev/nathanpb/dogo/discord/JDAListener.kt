...
*/
/**
 * Listens to JDA Event Bus and redirect it to Dogo [dev.nathanpb.dogo.core.eventBus.EventBus]
 *
...
class JDAListener(val bus: EventBus) : EventListener {
    ...
    override fun onEvent(event: Event?) {
        if(event != null && dev.nathanpb.dogo.core.DogoBot.ready) bus.submit(event)
    }
}